        ...
        <div className="h-15 border-b-2 border-slate-600 dark: dark:border-slate-400 ">
            <div className=" bg-slate-200 items-center justify-between flex dark:bg-black flex-wrap flex justify-between dark:text-teal-50" >
                ...
                <div className="flex items-center">
                    ...
                    <div className="mx-5 pr-5 flex animate-pulse"><Switcher/>
                    </div>
                    ...
                    <Link to={"https://owlsquill.de.r.appspot.com/"}><h1 className="mx-5 hover:bg-slate-400 dark:hover:bg-zinc-800 rounded-md hover:cursor-pointer p-1">Blog</h1></Link>
